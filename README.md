...
Este código de conducta aplica a todos los espacios bajo el control del equipo detrás de Dolphinstec, destacando principalmente:

* Espacios creados y/o administrados por Dolphinstec. Discord, etc
* Cualquier chat en vídeos publicados o eventos en vivo de Dolphinstec
* Otros que apliquen

## Aplicación del código de conducta

Los administradores y el equipo de Dolphinstec se comprometen a respetar y hacer valor el código de conducta para construir una comundiad libre de abuso y un espacio seguro para todas las personas.
...
Para dudas adicionales o preocupaciones acerca de algún conflicto o inconveniente por favor contactar a cualquier miembro del equipo de Dolphinstec.

## Reporte de violaciones al código de conducta

Si eres víctima de un comportamiento abusivo o de acoso de algún miembro de la comunidad, puedes alertar a algún miembro del equipo de CódigoFacilito a través del correo de ayuda en ayuda@Dolphinstec.tech. Si la persona involucrada en el incidente es parte del equipo de Dolphinstec, no será involucrada en el proceso para resolver el incidente.

El equipo de Dolphinstec responderá tan pronto sea posible. Si no recibes una respuesta pronta del equipo, por favor, pon tu seguridad personal y bienestar primero.
